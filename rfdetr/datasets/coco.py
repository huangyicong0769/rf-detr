...
class CocoDetection(torchvision.datasets.CocoDetection):
    def __init__(self, img_folder: Union[str, Path], ann_file: Union[str, Path], transforms: Optional[Any], include_masks: bool = False, num_classes=None, multi_label=False) -> None:
...
class ConvertCoco(object):
    ...
    def __init__(self, include_masks: bool = False, num_classes=None, multi_label=False) -> None:
        self.include_masks = include_masks
        self.num_classes = num_classes
        self.multi_label = multi_label
